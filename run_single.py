...
if __name__ == '__main__':
    ...
    key_params = {'min-grad':3, 'ffl-block':5, 'min-ele-area':25,
                  'merge-contained-ele':True, 'merge-line-to-paragraph':False, 'remove-bar':True}

    filename = args[1]   
    # set input image path
    input_path_img = 'data/input/1.jpg'
    input_path_img = 'data/input/news.jpg'
    input_path_img = 'data/input/cw.JPG'
    input_path_img = 'data/input/web.jpg'
    input_path_img = 'data/input/hc.jpg'
    input_path_img = 'data/input/mt.jpg'
    input_path_img = 'data/input/'+ filename + '.jpg'
...
#        text.text_detection(input_path_img, output_root, show=False)
        text.text_detection(input_path_img, output_root, show=visualize_flg)
    ...
    if is_ip:
        ...
        ip.compo_detection(input_path_img, output_root, key_params,
                           classifier=classifier, resize_by_height=resized_height, show=visualize_flg)
    ...
    if is_merge:
        ...
        merge.merge(input_path_img, compo_path, ocr_path, pjoin(output_root, 'merge'),
                    is_remove_bar=key_params['remove-bar'], is_paragraph=key_params['merge-line-to-paragraph'], show=visualize_flg)
