...
#from keras.applications.resnet import vgg16_model
...
#vgg16_model = vgg16_model(include_top=False, weights='imagenet',input_tensor=input_tensor)
vgg16_model = VGG16(include_top=True, weights='imagenet', input_tensor=input_tensor)

InceptionResNetV2_model = InceptionResNetV2(include_top=True, weights='imagenet', input_tensor=input_tensor, input_shape=None, pooling=None, classes=1000)
...
top_model = Model(inputs=InceptionResNetV2_model.input, outputs=top_model(InceptionResNetV2_model.output))
